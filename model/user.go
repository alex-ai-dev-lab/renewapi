...
// withNormalizedEmailLock serializes check-and-write operations for one email.
// SQLite already serializes writers; PostgreSQL and MySQL need an explicit
// transaction-scoped lock to prevent concurrent duplicate registrations.
...
// BindEmailToUser atomically checks availability and stores a normalized email.
