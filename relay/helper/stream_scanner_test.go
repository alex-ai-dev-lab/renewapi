...
func TestStreamScannerHandler_ClientCancelClosesUpstreamAndJoinsWorkers(t *testing.T) {
	...
	require.Error(t, err, "closed upstream body must reject further writes")
