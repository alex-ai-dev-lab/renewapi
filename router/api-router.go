	...
	anonymousRequestBodyLimit := middleware.AnonymousRequestBodyLimit()
	{
		...
		userRoute := apiRouter.Group("/user")
		{
			...
			selfRoute.Use(middleware.UserAuth())
			{
				...
				selfRoute.GET("/token", middleware.UserCriticalRateLimit("token"), controller.GenerateAccessToken)
				...
				selfRoute.POST("/aff_transfer", middleware.UserCriticalRateLimit("aff_transfer"), controller.TransferAffQuota)
		...
		channelRoute.Use(middleware.AdminAuth())
		{
			...
			channelRoute.GET("/:id/config_audits", controller.GetChannelConfigAudits)
			channelRoute.GET("/:id/capabilities", controller.GetChannelModelCapabilities)
			channelRoute.POST("/:id/capabilities/responses-compaction/probe", middleware.RootAuth(), middleware.CriticalRateLimit(), controller.ProbeChannelResponsesCompactionCapability)
			...
			channelRoute.POST("/codex/credential/normalize", controller.NormalizeCodexCredential)
			channelRoute.POST("/codex/credential/preflight", controller.PreflightCodexCredential)
			...
			channelRoute.POST("/:id/codex/credential/import", controller.ImportCodexCredentialForChannel)
