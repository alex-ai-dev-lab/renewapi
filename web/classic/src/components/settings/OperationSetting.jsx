...
import SettingsChannelTest from '../../pages/Setting/Operation/SettingsChannelTest';
  ...
  return (
    <>
      <Spin spinning={loading} size='large'>
        ...
        <Card style={{ marginTop: '10px' }}>
          <SettingsChannelTest options={inputs} refresh={onRefresh} />
        </Card>
        {/* 额度设置 */}
        <Card style={{ marginTop: '10px' }}>
