...
export function ChannelEffectiveSummary(props: ChannelEffectiveSummaryProps) {
  ...
  return (
    <section className='border-border/60 grid gap-3 rounded-md border p-3 sm:grid-cols-2 xl:grid-cols-4'>
      <div className='flex min-w-0 items-start gap-2'>
        ...
        <div className='min-w-0'>
          <div className='text-muted-foreground text-[11px]'>{t('Status')}</div>
          <div className='mt-1'>
