  ...
  return (
    <>
            ...
            >
              {isChannelDetailLoading ? (
                ...
                <Alert variant='destructive'>
                  <AlertDescription>
                    {t(
                      'Channel details could not be loaded. Return to the channel list and try again before saving changes.'
                    )}
                    {channelDetailErrorMessage ? (
                ...
                <>
                  {/* ── Basic Information ── */}
                  <div id='channel-basic' className='scroll-mt-28'>
                    <ChannelBasicSection>
                  ...
                  {/* ── API Access ── */}
                  <div id='channel-api-access' className='scroll-mt-28'>
                    <ChannelApiAccessSection>
                      ...
                      <div id='channel-auth' className='scroll-mt-28'>
                        <ChannelAuthSection>
                          {!isEditing && (
                            <FormField
                              control={form.control}
                  ...
                  {/* ── Models & Groups ── */}
                  <div id='channel-models' className='scroll-mt-28'>
                    <ChannelModelsSection>
                  ...
                  {/* ── Per-model Endpoints ── */}
                  <div id='channel-endpoints' className='scroll-mt-28'>
                    <ChannelModelEndpointsSection
                            ...
                            render={({ field }) => (
                              <FormItem className='flex items-center justify-between'>
                                <div className='space-y-0.5'>
                                  ...
                                  <FormDescription>
                                    {t(
                                      FIELD_DESCRIPTIONS.AUTO_TEST_AND_RECOVER
                                    )}
                                  </FormDescription>
                                </div>
                                <FormControl>
                            ...
                            <FormField
                              ...
                              render={({ field }) => (
                                <FormItem>
                                  ...
                                  <FormDescription>
                                    {t(
                                      'Channel selection overrides global model-category UA.'
                                    )}
                                  </FormDescription>
                                  <FormMessage />
                                </FormItem>
                            ...
                            <FormField
                              ...
                              render={({ field }) => (
                                <FormItem>
                                  ...
                                  <FormDescription>
                                    {t(
                                      'Inline UA has the highest priority for this channel.'
                                    )}
                                  </FormDescription>
                                  <FormMessage />
                                </FormItem>
                            ...
                            render={({ field }) => (
                              <FormItem className='flex items-center justify-between gap-4 px-4 py-3'>
                                <div className='space-y-0.5'>
                                  ...
                                  <FormDescription>
                                    {t(
                                      'Verified upstream compaction transports'
                                    )}
                                  </FormDescription>
                                </div>
                                <Select
                            ...
                            render={({ field }) => (
                              <FormItem className='flex items-center justify-between px-4 py-3'>
                                <div className='space-y-0.5'>
                                  ...
                                  <FormDescription>
                                    {t(
                                      'Native compaction streaming is verified'
                                    )}
                                  </FormDescription>
                                </div>
                                <FormControl>
      ...
      <ConfirmDialog
        ...
        desc={t(
          'You have unsaved channel changes. Leaving now will discard them.'
        )}
